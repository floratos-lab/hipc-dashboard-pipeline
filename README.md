...
Gene expression submission files are placed in the subdirectory "submissions/hipc_gene/".  An example signature file is "hipc_gene_21357945_1.txt", where 21357945 is the PMID of the publication, and "1" indicates the first signature from that paper.
